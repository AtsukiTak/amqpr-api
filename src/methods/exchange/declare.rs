...
pub fn declare(args: DeclareArguments) -> MethodPayload {
    ...
    let bits = Argument::Bits(bits_from_some_arg(args.passive,
                                                 args.durable,
                                                 args.auto_delete,
                                                 args.internal,
                                                 args.no_wait));
    ...
    let arguments = Arguments(vec![reserved_1, exchange_name_arg, exchange_type_arg, bits, table]);
...
fn bits_from_some_arg(passive: bool,
                      durable: bool,
                      auto_delete: bool,
                      internal: bool,
                      no_wait: bool)
